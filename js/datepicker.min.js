    ...
    $.datePicker = {
        ...
        utils: {
            ...
            buildDecadePicker: function(century, year) {
                ...
                var header = '<div class="row header">' + '<a href="#" class="prev' + (limit && firstDecade < 1900 ? ' disabled' : '') + '"><span class="arrow"></span></a>' + '<a href="#" class="century" data-century="' + (firstDecade + 10) + '">' + (firstDecade + 1) + '-' + (firstDecade + 100) + '</a>' + '<a href="#" class="next' + (limit && firstDecade == 1990 ? ' disabled' : '') + '"><span class="arrow"></span></a>' + '</div>';
            ...
            buildYearPicker: function(decade, year) {
                var obj = $.datePicker,
                    ...
                    limit = $.datePicker.defaults.limitCenturies;
                var header = '<div class="row header">' + '<a href="#" class="prev' + (limit && firstYear == 1899 ? ' disabled' : '') + '"><span class="arrow"></span></a>' + '<a href="#" class="decade" data-decade="' + (firstYear + 1) + '">' + (firstYear + 1) + '-' + (firstYear + 10) + '</a>' + '<a href="#" class="next' + (limit && firstYear == 2089 ? ' disabled' : '') + '"><span class="arrow"></span></a>' + '</div>';
                years.append(header);
                var n = 0;
                var type = '';
                var num = 0;
            ...
            buildMonthPicker: function(year, month) {
                var obj = $.datePicker,
                    ...
                    limit = $.datePicker.defaults.limitCenturies;
                var header = '<div class="row header">' + '<a href="#" class="prev' + (limit && year == 1900 ? ' disabled' : '') + '"><span class="arrow"></span></a>' + '<a href="#" class="year" data-year="' + year + '">' + year + '</a>' + '<a href="#" class="next' + (limit && year == 2099 ? ' disabled' : '') + '"><span class="arrow"></span></a>' + '</div>';
            ...
            buildCalendar: function(year, month, selected) {
                ...
                var header = '<div class="row header">' + '<a href="#" class="prev' + (limit && year == 1900 && month == 0 ? ' disabled' : '') + '"><span class="arrow"></span></a>' + '<a href="#" class="month" data-year="' + year + '" data-month="' + month + '">' + obj.strings.monthsFull[month] + ' ' + year + '</a>' + '<a href="#" class="next' + (limit && year == 2099 && month == 11 ? ' disabled' : '') + '"><span class="arrow"></span></a>' + '</div>';
